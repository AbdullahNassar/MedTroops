...
<section class="pager-sec bfr">
    ...
    <section class="departments-sec pt">
        <div class="container">
            <div class="department-sec tx-center">
                <div class="row">
                    @foreach($specials as $special)
                        @if(Config::get('app.locale') == 'ar')
                        <div class="col-md-3 col-sm-3 col-12 no-padding">
                            <div class="what-we-do-block">					
                                ...
                                <div class="what-we-do-block-content">
                                    <i><img src="{{asset('storage/uploads/special/'.$special->image)}}" alt="pulmonary"/></i>
                                    <h5>{{$special->special_name_ar}}</h5>
                                    <p>{{$special->content_ar}}</p>
                                </div>
                            </div>
                        </div>
                        @elseif(Config::get('app.locale') == 'en')
    ...
    </section><!--departments-sec end-->
@endsection
@include('site.pages.departments.scripts')