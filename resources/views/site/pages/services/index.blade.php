                ...
                <div class="col-xl-12">
                    <nav class="navbar navbar-expand-lg navbar-light d-flex justify-content-between">
                        ...
                        <form method="GET" action="{{route('site.search')}}" class="row banner-search">
                            ...
                            <div class="form_field tpmax">
                                <div class="form-group">
                                    <select class="form-control" name="service_ar">
                                        <option>التخصص</option>
                                        @foreach($departments as $department)
                                            <option value="{{$department->service_id}}">{{$department->service_name_ar}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form_field tpmax">
                                <div class="form-group">
                                    <select class="form-control" name="service">
                                        ...
                                        @foreach($departments as $department)
                                            <option value="{{$department->service_id}}">{{$department->service_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
