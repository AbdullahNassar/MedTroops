    ...
    <div class="container">
        <div class="pager-sec-details">
            ...
            <ul>
                ...
                <li><span>تعديل بيانات الدكتور</span></li>
            </ul>
            @elseif(Config::get('app.locale') == 'en')
            <h3>Edit Doctor Data</h3>
            <ul>
                <li><a href="{{route('site.home')}}" title="">Home</a></li>
                <li><span>Edit Doctor Data</span></li>
            </ul>
            @endif
                        ...
                        <div class="doctor_form_section">
                            ...
                            <form method="post" id="doctor_form" enctype="multipart/form-data">
                                ...
                                <div class="form-field half">
                                    <input type="text" name="doctor_name" placeholder="الاسم باللغة العربية" id="doctor_name" value="{{$doctor->doctor_name}}">
                                    <input type="hidden" value="{{$doctor->id}}" name="doctor_id" >
                                </div>
                                <div class="form-field half">
                                    <input type="text" name="doctor_name_ar" placeholder="الاسم باللغة الانجليزية" id="doctor_name_ar" value="{{$doctor->doctor_name_ar}}">
                                </div>
                                <div class="form-field half">
                                    <input type="text" name="username" placeholder="اسم المستخدم" id="username" value="{{$doctor->username}}">
                                </div>
                                <div class="form-field half">
                                    <input type="password" name="password" placeholder="كلمة السر" id="password" value="{{$doctor->recover}}">
                                </div>
                                <div class="form-field half">
                                    <input type="text" name="email" placeholder="البريد الالكترونى" id="email" value="{{$doctor->email}}">
                                </div>
                                <div class="form-field half">
                                    <input class="js-datepicker" type="text" name="birth" id="birth" placeholder="يوم الميلاد" value="{{$doctor->birth}}">
                                    <i class="input-icon fa fa-calendar"></i>
                                </div>
                                <div class="form-field half">
                                    <input type="text" name="phone" placeholder="رقم الهاتف" id="phone"  value="{{$doctor->phone}}">
                                </div>
                                <div class="form-field half rs-select2 js-select-simple select--no-search">
                                    <select class="select2" data-placeholder="اختر المناطق" name="area[]" id="area" multiple>
                                        @foreach ($doctorAreas as $doctorArea)
                                            <option value="{{$doctorArea->area_id}}" selected>{{$doctorArea->area_name_ar}}</option>
                                        @endforeach
                                ...
                                <div class="form-field half rs-select2 js-select-simple select--no-search">
                                    <select class="select2" data-placeholder="اختر التخصص"  name="specialty"  id="specialty">
                                        @foreach ($doctorSpecials as $doctorSpecial)
                                            <option value="{{$doctorSpecial->special_id}}" selected>{{$doctorSpecial->special_name_ar}}</option>
                                        @endforeach
                                ...
                                <div class="form-field half">
                                    <input type="file" name="cv" placeholder="قم بتحميل السيرة الذاتية" id="cv" value="{{$doctor->cv}}">
                                </div>
                                <div class="form-field">
                                    <input type="text" name="address_ar" placeholder="العنوان باللغة العربية" id="address_ar" value="{{$doctor->address_ar}}">
                                </div>
                                <div class="form-field">
                                    <input type="text" name="address" placeholder="العنوان باللغة الانجليزية" id="address" value="{{$doctor->address}}">
                                </div>
                                <div class="form-field">
                                    <textarea name="bio_ar" id="bio_ar" placeholder="تفاصيل باللغة العربية">{{$doctor->bio_ar}}</textarea>
                                </div>
                                <div class="form-field">
                                    <textarea name="bio" id="bio" placeholder="تفاصيل باللغة الانجليزية">{{$doctor->bio}}</textarea>
                                </div>
...
@endif
@endsection
@include('site.pages.editdoctor.scripts')