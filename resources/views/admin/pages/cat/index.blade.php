...
@endsection
@section('title','Doctor Served Cats')
@section('styles')
...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('cat.get')}}">Cats</a>
            <span class="breadcrumb-item active">Cats Table</span>
        </nav>
        </div><!-- br-pageheader -->
        ...
        <div class="br-section-wrapper">
            ...
            <table id="cat_table" class="table display responsive nowrap">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Category Name</th>
        ...
        <div id="catModal" class="modal fade">
            ...
            <div class="modal-content bd-0 tx-14">
                ...
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold modal-title">Add New cat</h6>
                ...
                <div class="form-layout">
                    <form method="post" id="cat_form" enctype="multipart/form-data">
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English ArCategoryea Name</label>
...
@endsection
@include('admin.pages.cat.scripts')