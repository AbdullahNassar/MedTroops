...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('special.get')}}">Specialities</a>
            <span class="breadcrumb-item active">Specialities Table</span>
        </nav>
        </div><!-- br-pageheader -->
        ...
        <div class="br-section-wrapper">
            ...
            <table id="special_table" class="table display responsive nowrap">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Title</th>
        ...
        <!-- modal -->
        <div id="specialModal" class="modal fade">
            <div class="modal-dialog modal-dialog-vertical-center modal-data" role="document">
            <div class="modal-content bd-0 tx-14">
                <div class="modal-header pd-y-20 pd-x-25">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold modal-title">Add New Speciality</h6>
                ...
                <div class="form-layout">
                    <form id="special_form" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="row mg-b-25">
                            <div class="col-lg-12">
                                <div class="user-img-upload">
                                    <div class="fileUpload user-editimg">
                                        ...
                                        <input type="file" id="imgInp" class="upload" name="special_image">
                                        <input type="hidden" value="special" name="storage" >
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Speciality Title</label>
                                    <input class="form-control" type="text" name="title_ar" id="title_ar">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Speciality Title</label>
                                    <input class="form-control" type="text" name="title_en" id="title_en">
                                </div>
                            </div><!-- col-12 -->
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Speciality Content</label>
                                    <textarea rows="2" class="form-control" name="content_ar" id="content_ar"></textarea>
                                </div>
                            </div><!-- col-6 -->
                            <div class="col-lg-6">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Speciality Content</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-toggle="toggle" data-onstyle="primary" name="active" id="active" checked>
                                </div>
                            </div><!-- col-4 -->
                        </div><!-- row -->
                ...
                <div class="modal-content bd-0">
                    <div class="modal-body pd-0">
                        <div class="row flex-row-reverse no-gutters">
                            ...
                            <img src="http://via.placeholder.com/912x912" class="img-fluid rounded-right pd-40" alt="" id="special-image">
                            </div><!-- col-6 -->
                            <div class="col-lg-8 rounded-left">
                            <div class="pd-40">
                                <h2 class="mg-b-5 tx-semibold tx-inverse" id="special-name"></h2>
                                <h5 class="mg-b-5 tx-inverse lh-2 " id="special-title"></h5>
                                <hr>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Speciality Content:</span>
                                    <span class="mg-b-20" id="special-content"></span>
                                </p>
                            </div>
                            </div><!-- col-6 -->
                        </div><!-- row -->
...
@endsection
@include('admin.pages.special.scripts')