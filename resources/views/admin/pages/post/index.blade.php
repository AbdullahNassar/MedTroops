...
@section('styles')
    ...
    <link href="{{asset('vendors/lib/ion.rangepost/css/ion.rangepost.css')}}" rel="stylesheet">
    <link href="{{asset('vendors/lib/ion.rangepost/css/ion.rangepost.skinFlat.css')}}" rel="stylesheet">
...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('post.get')}}">Posts</a>
            <span class="breadcrumb-item active">Posts Table</span>
        </nav>
        </div><!-- br-pageheader -->
        ...
        <div id="postModal" class="modal fade">
            ...
            <div class="modal-content bd-0 tx-14">
                ...
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold modal-title">Add New Post</h6>
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-3">
                                <div class="user-img-upload">
                                    <div class="fileUpload user-editimg">
                                        ...
                                        <input type="file" id="imgInp" class="upload" name="post_image">
                                        <input type="hidden" value="post" name="storage" >
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Post Title</label>
                                    <input class="form-control" type="text" name="title_ar" id="title_ar">
                                </div>
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Post Title</label>
                                    <input class="form-control" type="text" name="title_en" id="title_en">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">Arabic Post Header</label>
                                    <input class="form-control" type="text" name="head_ar" id="head_ar">
                                </div>
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label class="control-label">English Post Header</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    ...
                                    <select class="select2 pmd-select2 form-control" name="cat_id" id="cat_id">
                                        <option></option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label">Arabic Post Content</label>
                                    <textarea rows="2" class="form-control summernote" name="content_ar" id="content_ar"></textarea>
                                </div>
                            </div><!-- col-6 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label">English Post Content</label>
                                    <textarea rows="2" class="form-control summernote" name="content_en" id="content_en"></textarea>
                                </div>
                            </div><!-- col-6 -->
                ...
                <div class="modal-content bd-0">
                    <div class="modal-body pd-0">
                        <div class="row flex-row-reverse no-gutters">
                            ...
                            <img src="http://via.placeholder.com/912x912" class="img-fluid rounded-right pd-40" alt="" id="post-image">
                            </div><!-- col-6 -->
                            <div class="col-lg-8 rounded-left">
                            <div class="pd-40">
                                <h2 class="mg-b-5 tx-semibold tx-inverse" id="post-name"></h2>
                                <hr>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Post Category:</span>
                                    <span class="mg-b-20" id="post-cat"></span>
                                </p>
                                <p class="tx-inverse">
                                    <span class="tx-semibold tx-inverse">Post Header:</span>
                                    <span class="mg-b-20" id="post-header"></span>
                                </p>
                            </div>
                            </div><!-- col-6 -->
                        </div><!-- row -->
            ...
            <div class="modal-dialog">
                <div class = "modal-content" >
                    ...
                    <div class = "modal-header" >
                        <h4 class = "modal-title bold" >Are you sure you want to Delete this data?</h4>
                    </div>
        ...
        <div id="multi_delete-modal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class = "modal-content" >
                    {{csrf_field()}}
                    <div class = "modal-header" >
                        <h4 class = "modal-title bold" >Are you sure you want to Delete the selected raws?</h4>
                    </div>
                    <div class = "modal-body" >
                        <p >Note : all the data related to this item will be deleted also!</p>
                    </div>
...
@endsection
@include('admin.pages.post.scripts')